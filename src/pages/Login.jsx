      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center px-6">
        ...
        <div className="flex flex-col items-center md:items-start justify-center w-full">
          <div className="w-full max-w-sm">
            ...
            {/* Google bilan kirish */}
            <button className="w-full py-3 border border-gray-300 rounded-md flex items-center justify-center gap-2 hover:bg-gray-50 transition mb-6">
              <FcGoogle size={22} />
            ...
            <div className="text-sm text-center md:text-left text-gray-500 mb-2 hover:text-green-600 cursor-pointer">
